...
import fr.mistral.saphir.conteneur.backend.conteneurbackend.SpringApplicationContext;
import fr.mistral.saphir.conteneur.backend.conteneurbackend.requests.LoginUserRequest;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        String token = Jwts.builder()
                ...
                .claim("env", userDto.getEnvironement())
